const {
    ...
    exports.run = (client, message, paramaters) => {
      ...
      if (!question) {
        ...
        const embed = new RichEmbed().setDescription(`Question: **${question}**`).addField(`The magic 8ball says:`, `${responses[Math.floor(Math.random() * responses.length)]}`).setColor(EmbedColor)
